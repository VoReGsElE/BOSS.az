    ...
    public class Worker : User
    {
        ...
        public void ShowNotifications()
        {
            if (!IsNotificationExist())
                MessageBox.Show("There is no notification in your portfolio", "BOSS.az", MessageBoxButtons.OK);
            else
            {
        ...
        public void ShowJobOffers()
        {
            if (JobOffers.Count == 0)
                MessageBox.Show("There is no job offers in your portfolio", "BOSS.az", MessageBoxButtons.OK);
            else
            {
