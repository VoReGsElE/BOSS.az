...
using BOSS.az.Static_Classes_about_Common_Menu_Choices;
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                choice = Controle.MenuControle(bossFirstMenu).ToString();
                ...
                {
                    MessageBox.Show("Thank you visiting", "BOSS.az", MessageBoxButtons.OK);
                ...
                if (choice == BossFirstMenuChoices.Employer)
                {
                    while (true)
                    {
                        ...
                        //Console.Write("Enter choice: ");
                        //choice = Console.ReadLine();
                        choice = Controle.MenuControle(userHeadMenu).ToString();
                        ...
                        {
                            MessageBox.Show("See you next time goodbye.", "BOSS.az", MessageBoxButtons.OK);
                            break;
                        }
                        ...
                        if (!isConfirmedEmployer)
                            MessageBox.Show("Wrong Credentials", "BOSS.az", MessageBoxButtons.OK);
                        else
                        {
                            Console.Clear();
                            ...
                            while (true)
                            {
                                ...
                                //Console.Write("Enter choice: ");
                                //choice = Console.ReadLine();
                                choice = Controle.MenuControle(employerSecondMenu).ToString();
                                ...
                                {
                                    MessageBox.Show($"Good Luck {employer.Name} {employer.Surname}", "BOSS.az", MessageBoxButtons.OK);
                    ...
                    while (true)
                    {
                        ...
                        else
                        {
                            ...
                            while (true)
                            {
                                ...
                                //Console.Write("Enter choice: ");
                                //choice = Console.ReadLine();
                                choice = Controle.MenuControle(userSecondMenu).ToString();
                                ...
                                {
                                    MessageBox.Show($"Good Luck {worker.Name} {worker.Surname}", "BOSS.az", MessageBoxButtons.OK);
