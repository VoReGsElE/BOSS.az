...
using BOSS.az.Static_Classes_about_Employer_Menu_Choices;
    ...
    public static class EmployerMenus
    {
        public static void EmployerAboutWorkerSideSendJobOfferChoiceFilterMenu(List<Worker> workers, Employer employer)
        {
            ...
            while (true)
            {
                ...
                string choice = Controle.MenuControle(aboutWorkerSideSendJobOfferChoiceFilterMenuChoices).ToString();
                ...
                if (compatibleWithFilterInputCVs.Count == 0)
                    MessageBox.Show($"There is no compatible CV or CVs exist(s) for your search => \"{filterInputHelper}\"", "BOSS.az", MessageBoxButtons.OK);
                else
                {
                    ...
                    while (thisWorker == null)
                    {
                        ...
                        if (thisWorker == null)
                            MessageBox.Show($"There is no ID {id} CV exist", "BOSS.az", MessageBoxButtons.OK);
                        else
                            break;
                    }


                    DialogResult resultFinal = MessageBox.Show("Do you want offer job to worker who contains this CV ?", "BOSS.az", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
                    ...
                    if (resultFinal == DialogResult.Yes)
                    {
                        ...
                        while (announcement == null)
                        {
                            ...
                            if (announcement == null)
                                MessageBox.Show($"There is no ID {id} announcement exist in your portfolio", "BOSS.az", MessageBoxButtons.OK);
                        }
                        Console.Clear();
                        ...
                        if (thisWorker.JobOffers.Find(jo => jo.Message.Substring(0, jo.Message.IndexOf('\n') - 1) == $"ID: {long.Parse(id)}") != null
                            ...
                            MessageBox.Show($"You offer this job to this CV before or this worker accepted this job before", "BOSS.az", MessageBoxButtons.OK);
                        else
                        {
                            thisWorker.JobOffers.Add(new Notification($"{announcement}\nTo Your CV ID: {cvID}"));
                            MessageBox.Show($"Successfully send to worker, work ID {announcement.ID}, Speciality: {announcement.Speciality}", "BOSS.az", MessageBoxButtons.OK);
                        }
        ...
        public static void EmployerAboutAnnouncementSideUpdateChoiceMenu(List<Worker> workers, Employer employer)
        {
            ...
            while (true)
            {
                ...
                if (announcement == null)
                    MessageBox.Show($"There is no ID {id} announcement in your porfolio", "BOSS.az", MessageBoxButtons.OK);
                else
                {
                    while (true)
                    {
                        ...
                        //string choice = Console.ReadLine();
                        string choice = Controle.MenuControle(aboutAnnouncementSideUpdateChoiceMenu).ToString();
                            ...
                            case EmployerAboutAnnouncementSideUpdateChoiceMenuChoices.Speciality:
                                {
                                    ...
                                    DialogResult result = MessageBox.Show("Do you want to add this speciality to your announcement and don't delete other specialities ?", "BOSS.az", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
                                    ...
                                    try
                                    {
                                        ...
                                        Console.Clear();
                                        MessageBox.Show("Speciailty updated successfully", "BOSS.az", MessageBoxButtons.OK);
                                    }
                            ...
                            case EmployerAboutAnnouncementSideUpdateChoiceMenuChoices.City:
                                {
                                    ...
                                    DialogResult result = MessageBox.Show("Do you want to add this city to your announcement and don't delete other cities ?", "BOSS.az", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
                                    StringBuilder helper = new StringBuilder();
                            ...
                            case EmployerAboutAnnouncementSideUpdateChoiceMenuChoices.PayCheck:
                                {
                                    ...
                                    try
                                    {
                                        ...
                                        Console.Clear();
                                        MessageBox.Show("Pay check updated successfully", "BOSS.az", MessageBoxButtons.OK);
                                    }
                                    catch (Exception caption)
                                    {
                                        Console.Clear();
                            ...
                            case EmployerAboutAnnouncementSideUpdateChoiceMenuChoices.ExperienceYear:
                                {
                                    ...
                                    try
                                    {
                                        ...
                                        Console.Clear();
                                        MessageBox.Show("Experience Year updated successfully", "BOSS.az", MessageBoxButtons.OK);
                                    }
                                    catch (Exception caption)
                                    {
                                        Console.Clear();
                            ...
                            case EmployerAboutAnnouncementSideUpdateChoiceMenuChoices.Description:
                                {
                                    ...
                                    DialogResult result = MessageBox.Show("Do you want to add this description to your announcement and don't delete other descriptions ?", "BOSS.az", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
                                    StringBuilder helper = new StringBuilder();
                                    ...
                                    try
                                    {
                                        ...
                                        Console.Clear();
                                        MessageBox.Show("Description updated successfully", "BOSS.az", MessageBoxButtons.OK);
                                    }
                                    catch (Exception caption)
                                    {
                                        Console.Clear();
        ...
        public static void EmployerAboutAnnouncementSideMenu(List<Worker> workers, Employer employer)
        {
            ...
            while (true)
            {
                ...
                //string choice = Console.ReadLine();
                string choice = Controle.MenuControle(aboutAnnouncementSideMenu).ToString();
                ...
                switch (choice)
                {
                    case EmployerAboutAnnouncementSideMenuChoices.Add:
                        {
                            ...
                            try
                            {
                                ...
                                MessageBox.Show("Announcement Added Successfully", "BOSS.az", MessageBoxButtons.OK);
                            }
                            catch (Exception caption)
                            {
                                Console.Clear();
                    ...
                    case EmployerAboutAnnouncementSideMenuChoices.DeleteWithID:
                        {
                            if (employer.Announcements.Count == 0)
                                MessageBox.Show("There is no announcement in your porfolio", "BOSS.az", MessageBoxButtons.OK);
                            else
                            {
                                ...
                                {
                                    DialogResult result = MessageBox.Show($"Do you want to delete ID {id} announcement in your portfolio ?", "BOSS.az", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
                                    ...
                                    if (result == DialogResult.Yes)
                                    {
                                        ...
                                        MessageBox.Show($"Announcement ID {id} deleted successfully", "BOSS.az", MessageBoxButtons.OK);
                                    }
                    ...
                    case EmployerAboutAnnouncementSideMenuChoices.UpdateWithID:
                        {
                            if (employer.Announcements.Count == 0)
                                MessageBox.Show("There is no Announcement in your portfolio", "BOSS.az", MessageBoxButtons.OK);
                            else
        ...
        public static void EmployerAboutWorkerSideMenu(List<Worker> workers, Employer employer)
        {
            ...
            while (true)
            {
                ...
                //Console.Write("Enter choice: ");
                //string choice = Console.ReadLine();
                string choice = Controle.MenuControle(aboutWorkerSideMenu).ToString();
                    ...
                    case EmployerAboutWorkerSideMenuChoices.ShowIncomingRequestsFromWorkers:
                        {
                            ...
                            if (employer.Announcements.Count == 0)
                                ...
                                MessageBox.Show("There is no request from any worker to your announcements", "BOSS.az", MessageBoxButtons.OK);
                            else
                            {
                                ...
                                if (announcement == null)
                                    MessageBox.Show($"There is no ID {id} announcement exist in your portofolio", "BOSS.az", MessageBoxButtons.OK);
                                else
                                {
                                    ...
                                    if (apply == null)
                                        MessageBox.Show($"There is no ID {id} apply exist in your announcement", "BOSS.az", MessageBoxButtons.OK);
                                    else
                                    {
                                        DialogResult result = MessageBox.Show("Do you want to Accept worker (who contains this CV ) to your work ?", "BOSS.az", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Question);
                                        ...
                                        MessageBox.Show($"Operation {result} done successfully", "BOSS.az", MessageBoxButtons.OK);
                    ...
                    case EmployerAboutWorkerSideMenuChoices.SendJobOfferToWorkersWhoAreInTheSystem:
                        {
                            ...
                            if (employer.Announcements.Count == 0)
                                ...
                                MessageBox.Show("There isn't any CV in the system right now", "BOSS.az", MessageBoxButtons.OK);
                            else
                            {
                                DialogResult result = MessageBox.Show("Do you want to filter CVs ?", "BOSS.az", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
                    ...
                    case EmployerAboutWorkerSideMenuChoices.ShowNotificationsAboutJobOffers:
                        {
                            if (employer.notesFromJobOffers.Count == 0)
                                MessageBox.Show("There is no notification respond to job offers.", "BOSS.az", MessageBoxButtons.OK);
                            else
                            {
