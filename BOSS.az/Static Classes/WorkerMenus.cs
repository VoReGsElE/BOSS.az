...
using BOSS.az.Helper_Static_Classes;
//using BOSS.az.Static_class_about_Worker_Menu_Choices;
using BOSS.az.Static_Classes_about_Worker_Menu_Choices;
using System;
    ...
    public static class WorkerMenus
    {
        public static void WorkerCVSideUpdateChoiceMenu(Worker worker, List<Employer> employers)
        {
            while (true)
            {
                ...
                if (cv == null)
                {
                    MessageBox.Show($"There is no ID {id} CV exist in your portfolio", "BOSS.az", MessageBoxButtons.OK);
                    return;
                }
                ...
                while (true)
                {
                    ...
                    string choice = Controle.MenuControle(updateForms).ToString();
                        ...
                        case WorkerCVSideUpdateChoiceMenuChoices.UpdateBySpeciality:
                            {
                                ...
                                DialogResult result = MessageBox.Show("Do you want to add this speciality to your portfolio and don't delete other specialities ?", "BOSS.az", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
                                ...
                                try
                                {
                                    ...
                                    Console.Clear();
                                    MessageBox.Show("Speciality updated successfully", "BOSS.az", MessageBoxButtons.OK);
                                }
                                catch (Exception caption)
                                {
                                    Console.Clear();
                                    MessageBox.Show(caption.Message, "BOSS.az", MessageBoxButtons.OK);
                        ...
                        case WorkerCVSideUpdateChoiceMenuChoices.UpdateByCity:
                            {
                                ...
                                DialogResult result = MessageBox.Show("Do you want to add this city to your portfolio and don't delete other cities ?", "BOSS.az", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
                                StringBuilder helper = new StringBuilder();
                                try
                                {
                                    helper.Append(", ")
                                    ...
                                    Console.Clear();
                                    MessageBox.Show("City updated successfully", "BOSS.az", MessageBoxButtons.OK);
                                }
                                catch (Exception caption)
                                {
                                    Console.Clear();
                        ...
                        case WorkerCVSideUpdateChoiceMenuChoices.UpdateByForeignLanguage:
                            {
                                ...
                                DialogResult result = MessageBox.Show("Do you want to add this foreign language to your portfolio and don't delete other languages ?", "BOSS.az", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
                                StringBuilder helper = new StringBuilder();
                                ...
                                try
                                {
                                    ...
                                    Console.Clear();
                                    MessageBox.Show("Foreign Language updated successfully", "BOSS.az", MessageBoxButtons.OK);
                                }
                                catch (Exception caption)
                                {
                                    Console.Clear();
                        ...
                        case WorkerCVSideUpdateChoiceMenuChoices.UpdateByWorkedCompanies:
                            {
                                ...
                                DialogResult result = MessageBox.Show("Do you want to add this worked company to your portfolio and don't delete other worked companies ?", "BOSS.az", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
                                StringBuilder helper = new StringBuilder();
                                ...
                                try
                                {
                                    ...
                                    Console.Clear();
                                    MessageBox.Show("Worked Companies updated successfully", "BOSS.az", MessageBoxButtons.OK);
                                }
                                catch (Exception caption)
                                {
                                    Console.Clear();
                        ...
                        case WorkerCVSideUpdateChoiceMenuChoices.UpdateBySkills:
                            {
                                ...
                                DialogResult result = MessageBox.Show("Do you want to add this skill to your portfolio and don't delete other skills ?", "BOSS.az", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
                                StringBuilder helper = new StringBuilder();
                                ...
                                try
                                {
                                    ...
                                    Console.Clear();
                                    MessageBox.Show("Skills updated successfully", "BOSS.az", MessageBoxButtons.OK);
                                }
                                catch (Exception caption)
                                {
                                    Console.Clear();
                        ...
                        case WorkerCVSideUpdateChoiceMenuChoices.UpdateByAll:
                            {
                                try
                                {
                                    ...
                                    Console.Clear();
                                    MessageBox.Show("CV updated successfully", "BOSS.az", MessageBoxButtons.OK);
                                }
                                catch (Exception caption)
                                {
                                    Console.Clear();
        ...
        public static void WorkerCVSideMenu(Worker worker, List<Employer> employers)
        {
            ...
            while (true)
            {
                ...
                //string choice = Console.ReadLine();
                string choice = Controle.MenuControle(cvSideMenu).ToString();
                ...
                {
                    MessageBox.Show("See you soon", "BOSS.az", MessageBoxButtons.OK);
                    break;
                }
                    ...
                    case WorkerCVSideMenuChoices.ShowMoreWithID:
                        {
                            ...
                            {
                                Console.Clear();
                                MessageBox.Show("There is no CV in your portfolio", "BOSS.az", MessageBoxButtons.OK);
                            }
                            else
                            {
                    ...
                    case WorkerCVSideMenuChoices.AddCV:
                        {
                            try
                            {
                                ...
                                worker.CV.Add(cv);
                                MessageBox.Show("CV added successfully to your portfolio", "BOSS.az", MessageBoxButtons.OK);
                            }
                            catch (Exception caption)
                            {
                                MessageBox.Show(caption.Message, "BOSS.az", MessageBoxButtons.OK);
                    ...
                    case WorkerCVSideMenuChoices.DeleteCVWithID:
                        {
                            ...
                            else
                            {
                                ...
                                try
                                {
                                    ...
                                    DialogResult result = MessageBox.Show($"Do you want to delete CV ID {id} in your portfolio ?", "BOSS.az", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
                                    ...
                                    if (result == DialogResult.Yes)
                                    {
                                        ...
                                        MessageBox.Show($"CV ID {long.Parse(id)} deleted successfully", "BOSS.az", MessageBoxButtons.OK);
                                    }
                                    else
                                    {
                                        MessageBox.Show($"CV ID {id} didn't delete", "BOSS.az", MessageBoxButtons.OK);
                                    }
        ...
        public static void WorkerAnnouncementSideFilterChoiceMenu(Worker worker, List<Employer> employers)
        {
            ...
            //Console.Write("Enter choice: ");
            //string choice = Console.ReadLine();
            string choice = Controle.MenuControle(filterMenu).ToString();
            ...
            {
                MessageBox.Show($"No announcements exist for this => {filterKey}", "BOSS.az", MessageBoxButtons.OK);
                return;
            }
            ...
            while (true)
            {
                ...
                //Console.Write("Enter choice: ");
                //choice = Console.ReadLine();
                choice = Controle.MenuControle(userAnnouncementSideFilterChoiceMenu).ToString();
                    ...
                    case WorkerAnnouncementSideFilterChoiceMenuChoices.ShowMoreAboutAnnouncementWithID:
                        {
                            ...
                            if (c != null)
                            {
                                ...
                                MessageBox.Show($"There is no ID {id} announcement exist", "BOSS.az", MessageBoxButtons.OK);
                            ...
                            else
                            {
                                    ...
                                    foreach (var cv in worker.CV)
                                    {
                                        ...
                                        if (announcement.appliedWorkersCV.Contains(thisCV))
                                        {
                                            ...
                                            DialogResult result = MessageBox.Show("Do you want to remove this CV ? You applied this announcement before."
                                                , "BOSS.az", MessageBoxButtons.YesNo);
                                            ...
                                            if (result == DialogResult.Yes)
                                            {
                                                ...
                                                MessageBox.Show("CV remove successfully", "BOSS.az", MessageBoxButtons.OK);
                                            }
                                            else
                                                flag = false;
                                ...
                                if (announcement != null && flag)
                                {
                                    ...
                                    if (cv != null)
                                    {
                                        ...
                                        MessageBox.Show($"CV ID {id} sent successfully", "BOSS.az", MessageBoxButtons.OK);
                                    }
                                    else
                                        MessageBox.Show($"There is no ID {id} cv exist in your portfolio", "BOSS.az", MessageBoxButtons.OK);
                                    ...
                                    MessageBox.Show($"There is no ID {id} announcement exist or you applied this announcement before", "BOSS.az", MessageBoxButtons.OK);
                            }
                        }
                        break;
                }
        ...
        public static void WorkerAnnouncementSideMenu(Worker worker, List<Employer> employers)
        {
            ...
            while (true)
            {
                ...
                //Console.Write("Enter choice: ");
                //string choice = Console.ReadLine();
                string choice = Controle.MenuControle(userAnnouncementSideMenu).ToString();
                    ...
                    case WorkerAnnouncementSideMenuChoices.ShowMoreAboutAnnouncementWithID:
                        {
                            ...
                            {
                                Console.Clear();
                                MessageBox.Show("There is no announcement in the system right now", "BOSS.az", MessageBoxButtons.OK);
                            }
                            else
                            {
                                Console.Write("\nWhich ID do you want to show: ");
                                ...
                                if (c != null)
                                {
                                    c.ShowMore();
                                    c.IncreaseView(worker.UserName);
                                    MessageBox.Show($"Press Ok to continue", "BOSS.az", MessageBoxButtons.OK);
                                }
                                else
                                    MessageBox.Show($"There is no ID {id} announcement exist", "BOSS.az", MessageBoxButtons.OK);
                            }
                    ...
                    case WorkerAnnouncementSideMenuChoices.ApplyAnnouncementWithID:
                        {
                            ...
                            {
                                Console.Clear();
                                MessageBox.Show("There is no announcement exist in the system right now", "BOSS.az", MessageBoxButtons.OK);
                            }
                            ...
                            else
                            {
                                ...
                                {
                                    MessageBox.Show("Employer Accepted you to this work or you Accepted this work and you can not send CV", "BOSS.az", MessageBoxButtons.OK);
                                }
                                else if (isEmployerSendThisIDJobToThisWorker)
                                {
                                    MessageBox.Show($"Employer Send ID {id} job to your job offers box", "BOSS.az", MessageBoxButtons.OK);
                                }
                                else
                                {
                    ...
                    case WorkerAnnouncementSideMenuChoices.ShowNotifications:
                        {
                            ...
                            if (worker.IsNotificationExist())
                                MessageBox.Show("All done", "BOSS.az", MessageBoxButtons.OK);
                        }
                        break;
                            ...
                            if (worker.JobOffers.Count != 0)
                            {
                                ...
                                if (worker.JobOffers.Find(jo => jo.Message.Substring(0, jo.Message.IndexOf('\n') - 1) == $"ID: {long.Parse(id)}") != null)
                                {
                                    foreach (var employer in employers)
                                    {
                                        ...
                                        if (respond != null)
                                        {
                                            DialogResult result = MessageBox.Show($"Do you want to Accept {respond.Speciality} Job ?", "BOSS.az", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Question);
                                            ...
                                            MessageBox.Show($"Operation {result} done succesfully", "BOSS.az", MessageBoxButtons.OK);
                                    ...
                                    MessageBox.Show("Wrong Id selected", "BOSS.az", MessageBoxButtons.OK);
                            }
                            else
                                MessageBox.Show("There is no job offer in your portfolio", "BOSS.az", MessageBoxButtons.OK);
